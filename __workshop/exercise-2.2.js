...
greeting("de").then((result) => console.log(result)); // { lang: "French", code: "FR", text: "Bonjour" }

greeting("ko").then((result) => console.log(result)); // { lang: "French", code: "FR", text: "Bonjour" }
